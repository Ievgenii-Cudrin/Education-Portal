namespace EducationPortalConsoleApp.Controller
{
    ...
    public class UserController : IUserController
    {
        ...
        public void ShowAllPassedCourses()
        {
            ...
            List<CourseViewModel> passedCourses = this.mapperService.CreateListMapFromVMToDomainWithIncludeLsitType<Course, CourseViewModel, Material, MaterialViewModel, Skill, SkillViewModel>(this.logInService.AuthorizedUser.CoursesPassed.ToList());
        ...
        public void ShowAllCourseInProggres()
        {
            ...
            List<CourseViewModel> coursesInProgress = this.mapperService.CreateListMapFromVMToDomainWithIncludeLsitType<Course, CourseViewModel, Material, MaterialViewModel, Skill, SkillViewModel>(this.logInService.AuthorizedUser.CoursesInProgress.ToList());
        ...
        public void ShowUserInfo()
        {
            ...
            // show user info
            Console.WriteLine($"Name - {this.logInService.AuthorizedUser.Name}\n" +
                $"Phone Number - {this.logInService.AuthorizedUser.PhoneNumber}\n" +
                $"Email - {this.logInService.AuthorizedUser.Email}\n");
